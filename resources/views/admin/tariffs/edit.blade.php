...
@section('content')
    ...
    <section class="content">
        ...
        <div class="col-xs-12">
            <div class="row">
                {!! Form::open(['route' => ['admin.tariffs.update', $tariff->id], 'method' => 'put']) !!}
                            ...
                            <div class="row">
                                <div class="col-xs-6" style="padding-left:0;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ ($old = old('title')) ? $old : $tariff->getTitle() }}" class="form-control" name="title" placeholder="Введите название тарифа">
                                    </div>
                                </div>
                                <div class="col-xs-6" style="padding-right:0;">
                                    <div class="form-group">
                                        <label for="slug">Топ</label>
                                        <input type="number" value="{{ ($old = old('top')) ? $old : $tariff->getTopNumber() }}" min="0" class="form-control" name="top">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-6" style="padding-left:0;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ ($old = old('top')) ? $old : $tariff->getWhom() }}" name="whom" placeholder="Для малого бизнеса">
                                    </div>
                                </div>
                                <div class="col-xs-6" style="padding-right:0;">
                                    <div class="form-group">
                                        <label for="desc">Доп. услуга</label>
                                        <input type="text" class="form-control" value="{{  ($old = old('additional_service')) ? $old : $tariff->getAdditionalService() }}" name="additional_service" placeholder="Наполнение карточки">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6" style="padding-left:0;">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" step="any" value="{{ $price->getPrice() }}" name="prices[]">
                                            ...
                                            <div class="col-xs-6" style="padding-right:0;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $price->getRange() }}" name="ranges[]" placeholder="1 месяц">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <select name="services[]" multiple="multiple" class="form-control select2 select2-hidden-accessible services-select" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                        @foreach($services as $service)
                                            <option value="{{ $service->id }}" {{ in_array($service->id, $tariff_services) ? 'selected' :'' }}>{{ $service->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            @else
