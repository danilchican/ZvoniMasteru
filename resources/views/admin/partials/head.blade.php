...
<head>
    ...
    <title>ZvoniMasteru | {{ $titlePage }}</title>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ $companyLogo = Auth::user()->company->getLogo() }}" class="user-image"
                                 alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    @endif
                                    <small>
                                        Зарегистрирован {{ LocalizedCarbon::instance(Auth::user()->created_at)->diffForHumans() }}</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ route('account.index') }}" class="btn btn-default btn-flat">Мой
                                        аккаунт</a>
                                </div>
